...
<body>
    ...
    <div class="side-bar"><br>
        ...
        <a href="/coaches" class="view_coaches">Coaches</a><br><br>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    @foreach($content as $coach)
                        @if($coach->Admin == 0)
                        <tr>
                            <td>
                                <span class="custom-checkbox">
                                    <input type="checkbox" id="{{ $coach->Id }}" value="1">
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="post" action="/add_coach">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Id</label>
							<input type="text" name="new_id" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Email</label>
